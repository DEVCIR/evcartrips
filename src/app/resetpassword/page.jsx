  ...
  return (
    <div className="w-svw min-h-screen bg-white overflow-x-hidden">
      ...
      >
        ...
        <motion.div 
          className="max-w-sm md:max-w-md lg:max-w-5xl fhd:max-w-5xl 2k:max-w-7xl 4k:max-w-[115rem] mx-auto w-full space-y-2 fhd:space-y-4 2k:space-y-6 4k:space-y-8 mt-4 xl:mt-24  2k:mt-32 4k:mt-66  text-center"
        ...
        >
          ...
          <motion.div 
            className="text-[#FFFFFFAB] font-[400] text-[14px] -tracking-[0.41px] md:text-[1px] md:-tracking-[0.68px] xl:text-[40px] fhd:text-[50px] 2k:text-[70px] 4k:text-[100px] xl:-tracking-[1.17px] xl:-space-y-3"
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <motion.p
              ...
              animate={isHeaderInView ? { opacity: 1, y: 0 } : {}}
            >
              reset link and get back on track.
            </motion.p>
          </motion.div>
        </motion.div>
      </motion.div>
      ...
      <motion.div
        ref={formRef}
        className="-mt-24 md:-mt-18 lg:-mt-36 xl:-mt-40 fhd:-mt-52 2k:-mt-60 4k:-mt-80 pb-8 fhd:pb-16 2k:pb-20 4k:pb-28 z-40"
        initial={{ opacity: 0, y: 50 }}
