  ...
  return (
    <div className="w-full min-h-screen bg-white overflow-hidden">
      ...
      >
        ...
        <motion.div 
          className="max-w-sm md:max-w-md lg:max-w-lg fhd:max-w-3xl 2k:max-w-5xl 4k:max-w-7xl mx-auto w-full space-y-2 fhd:space-y-4 2k:space-y-6 4k:space-y-8 mt-4 xl:mt-24  2k:mt-32 4k:mt-66  text-center"
