...
const MapComplete = dynamic(
  () => import('../common_components/mapcomplete/page'),
  { 
    ssr: false,
    loading: () => <div className="h-[55rem] sm:h-[40rem] md:h-[85rem] lg:h-[56rem] xl:h-[146rem] bg-gray-200 animate-pulse rounded-2xl" />
  }
);
  ...
  return (
    <div className="min-h-screen bg-white" data-aos="fade-in">
      ...
      <div className="bg-black px-3 sm:px-4 md:px-6 lg:px-8 xl:px-14 pt-4 pb-12 sm:pb-16 min-h-[54vh] md:min-h-[40vh] flex flex-col justify-start rounded-b-[24px] sm:rounded-b-[32px] md:rounded-none">
        <div className="xl:hidden"><Navbar1 /></div>
        <div className="max-xl:hidden"><Navbar /></div>
  ...
  <div className="max-md:hidden absolute right-28 top-32 xl:right-36 xl:top-52 bg-[#323232] rounded-md w-[49px] h-[46px] xl:w-[80px] xl:h-[75px]" data-aos="fade-left"
    ...
    <Edit className="w-5 h-5 xl:w-8 xl:h-8 z-10 text-[#F96C41] mx-auto my-3 xl:my-5" />
      ...
      <div className="max-md:px-8 max-md:-mt-32 pb-8">
        <div className="max-w-full mx-auto" data-aos="zoom-in"
    data-aos-delay="400">
      ...
      {/* Other Sections */}
      <div className="px-8 mt-4 pb-8 xl:px-32" data-aos="fade-up"
    data-aos-delay="700">
        <CarDiv />
      </div>
      
      <div className="px-8 mt-4 pb-8 xl:px-32 max-md:hidden" data-aos="fade-up"
    data-aos-delay="800">
        <Rentals />
      </div>
    </div>
