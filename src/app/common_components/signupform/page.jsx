...
import { toast , ToastContainer} from "react-toastify" // or any other toast notification library you're using
  ...
  return (
    <div className="bg-[#FFFFFF] rounded-t-3xl rounded-b-3xl shadow-xl px-4 md:px-6 py-6 mx-2 md:mx-4 -mt-4 relative z-10">
      <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
        {/* First Name */}
        <div>
          <label className="text-[#00000082] text-sm md:text-base font-medium mb-1 md:mb-2 block">
        ...
        <Button
          type="submit"
          disabled={loading}
          className={`w-full bg-gradient-to-b from-[#F96C41] to-[#AA3916] text-white font-semibold py-3 md:py-4 rounded-lg h-12 md:h-14 text-base md:text-lg mt-3 md:mt-0 ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
        >
        ...
        <Button
          ...
          className="w-full border-0 text-gray-800 font-semibold py-3 md:py-4 rounded-lg h-12 md:h-14 text-base md:text-lg"
        >
          ALREADY HAVE AN ACCOUNT
        </Button>

        <div className="relative flex items-center justify-center">
          <span className="flex-shrink mx-4 text-[#F96C41] text-sm md:text-base">or continue with</span>
        </div>

        <div className="flex justify-center space-x-6">
          <button type="button" className="p-2 rounded-lg bg-[#D9D9D9] hover:bg-[#D9D9D9]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
