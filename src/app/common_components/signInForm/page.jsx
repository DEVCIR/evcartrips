...
export default function SignInForm() {
  ...
  return (
    <div className="w-[350px] h-[400px] md:w-[586px] md:h-[600px] xl:w-[680px] xl:h-[680px] bg-[#FFFFFF] rounded-t-3xl rounded-b-3xl shadow-xl px-4 md:px-6 xl:px-10 xl:py-10 py-6 -mt-4 relative z-10 mx-auto">
      <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
        <div>
          <label className="text-[#00000082] text-[10px] -tracking-[0.41px] md:text-[16px] md:-tracking-[0.68px] xl:text-[28px] xl:-tracking-[1.17px] font-medium mb-1 md:mb-2 block">Email Address</label>
        ...
        <div>
          <label className="text-[#00000082] text-[10px] -tracking-[0.41px] md:text-[16px] md:-tracking-[0.68px] xl:text-[28px] xl:-tracking-[1.17px] font-medium mb-1 md:mb-2 block">Password</label>
          <div className="relative">
            <div className="absolute left-3 top-1/2 transform -translate-y-1/2">
              <svg className="w-[24px] h-[24px] md:w-[30px] md:h-[30px] xl:w-[40px] xl:h-[40px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Button
          variant="outline"
          className="w-full border-none shadow-none text-gray-800 font-bold rounded-lg text-[10px] -tracking-[0.41px] md:text-[16px] md:-tracking-[0.68px] xl:text-[20px] xl:-tracking-[1.17px] py-0 my-0 xl:my-2"
        >
          CREATE AN NEW ACCOUNT
        </Button>

        <div className="relative flex items-center justify-center py-0">
          <span className="flex-shrink mx-4 text-[#F96C41] font-semibold text-[10px] -tracking-[0.41px] md:text-[16px] md:-tracking-[0.68px] xl:text-[20px] xl:-tracking-[1.17px]">or continue with</span>
        </div>
