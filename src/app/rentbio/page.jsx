    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.div
            className="flex flex-wrap items-center gap-1 sm:gap-2 md:gap-5 xl:gap-10 fhd:gap-16 2k:gap-24 4k:gap-32 fhd:bg-amber-300 2k:bg-blue-500 4k:bg-red-500 8k:bg-purple-600 "
          ...
          <motion.div
            className="max-md:hidden absolute right-28 4k:right-72 top-32 xl:right-36 xl:top-52 2k:top-[24rem] 4k:top-[34rem] bg-[#323232] rounded-md w-[49px] h-[46px] xl:w-[80px] xl:h-[75px] 2k:w-[100px] 2k:h-[90px] 4k:w-[140px] 4k:h-[135px]"
