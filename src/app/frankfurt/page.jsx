...
function Page() {
  // Add this near the top of your Page component, before the fetchHotels function
const dummyHotels = [
  {
    id: "dummy-1",
    ...
    image: "/images/1.jpg",
    distance: 2.5,
    amenities: ["Air conditioning", "WiFi", "Parking", "Pool", "Gym"],
    chain: "International Chain",
    roomType: "Deluxe King",
    roomImage: "/images/defaultroom.jpg",
    refundable: true,
    city: "New York",
    geo: "40.7128;-74.0060",
    checkin: "20230715",
  ...
  },
  {
    ...
    image: "/images/2.jpg",
    distance: 0.5,
    amenities: ["Air conditioning", "WiFi", "Parking", "Beach Access", "Spa"],
    chain: "Luxury Collection",
    roomType: "Ocean View Suite",
    roomImage: "/images/oceanview.jpg",
    refundable: true,
    city: "Miami",
    geo: "25.7617;-80.1918",
    checkin: "20230715",
  ...
  },
  {
    ...
    rating: 3.8,
    address: "789 Alpine Road, Mountain District",
    nights: 1,
    travelers: 2,
    price: 159,
    image: "/images/3.jpg",
    distance: 15,
    amenities: ["Air conditioning", "WiFi", "Parking", "Restaurant"],
    chain: "Local Chain",
    roomType: "Standard Room",
    roomImage: "/images/mountainroom.jpg",
    refundable: false,
    city: "Denver",
  ...
  },
  {
    ...
    rating: 4.0,
    address: "321 City Center Avenue",
    nights: 1,
    travelers: 2,
    price: 179,
    image: "/images/4.jpg",
    distance: 1.2,
    amenities: ["Air conditioning", "WiFi", "Parking", "Bar", "Concierge"],
    chain: "Boutique Collection",
    roomType: "Executive Room",
    roomImage: "/images/boutiqueroom.jpg",
    refundable: true,
    city: "Chicago",
    geo: "41.8781;-87.6298",
    checkin: "20230715",
  ...
  },
  {
    ...
    image: "/images/5.jpg",
    distance: 3.8,
    amenities: ["Air conditioning", "WiFi", "Parking", "Historic Charm"],
    chain: "Independent",
    roomType: "Heritage Suite",
    roomImage: "/images/historicroom.jpg",
    refundable: false,
    city: "Boston",
    geo: "42.3601;-71.0589",
    checkin: "20230715",
  ...
  },
  {
    ...
    rating: 3.5,
    address: "987 Terminal Road, Airport Zone",
    nights: 1,
    travelers: 2,
    price: 129,
    image: "/images/6.jpg",
    distance: 0.1,
    amenities: ["Air conditioning", "WiFi", "Parking", "Airport Shuttle"],
    chain: "Transit Hotels",
    roomType: "Standard Twin",
    roomImage: "/images/airportroom.jpg",
    refundable: true,
    city: "Los Angeles",
        ...
        <div className="container mx-auto py-10 fhd:py-12 2k:py-16 4k:py-22">
          ...
          >
            ...
            >
              ...
              >
                Showing results {filteredHotels.length} of {dummyHotels.length}
              </motion.p>
