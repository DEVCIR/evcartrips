          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full fhd:px-8 2k:px-12 4k:px-18 px-5 py-4 border fhd:py-7 2k:py-10 4k:py-16 fhd:text-2xl 2k:text-4xl 4k:text-6xl border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
              />
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
            <div className="relative">
              ...
              <select
                ...
                className="w-full px-5 py-4 2k:px-12 4k:px-18 fhd:px-8  fhd:py-7  2k:py-9 4k:py-16  border border-gray-300 rounded-lg fhd:text-2xl 2k:text-4xl 4k:text-6xl text-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
              >
