...
export default function FAQ() {
  ...
  return (
    <div className="w-full min-h-screen bg-white text-white overflow-hidden">
      ...
      {/* Breadcrumb */}
      <div className="w-full max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-5xl  fhd:max-w-[1430px] 2k:max-w-[2005px] 4k:max-w-[2995px]   mx-auto px-4 pt-4 mb-2 fhd:mb-4 2k:mb-8 4k:mb-14 -mt-60 fhd:-mt-[21rem] 2k:-mt-[29rem] 4k:-mt-[42rem]">
