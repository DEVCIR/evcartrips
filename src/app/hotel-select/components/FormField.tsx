  ...
  return (
    <div className="relative">
      ...
      {field.type === "date" ? (
        ...
        <select
          className="w-full border fhd:text-3xl 2k:text-4xl 4k:text-5xl rounded-lg fhd:rounded-2xl 2k:rounded-3xl 4k:rounded-4xl p-5 fhd:p-8 2k:p-12 4k:p-18 max-sm:p-4 appearance-none bg-white"
          value={field.value}
