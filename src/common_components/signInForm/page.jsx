...
export default function SignInForm() {
  ...
  return (
    <motion.div
      className="w-[350px] h-auto md:w-[586px] xl:w-[680px] fhd:w-[1030px] 2k:w-[1358px] 4k:w-[2050px] bg-[#FFFFFF] rounded-t-3xl rounded-b-3xl shadow-xl px-4 md:px-6 xl:px-10 2k:px-14 4k:px-20 xl:py-10 py-6 2k:py-14 4k:py-24 -mt-4 relative z-40 mx-auto"
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5 fhd:space-y-7 2k:space-y-10 4k:space-y-16">
        ...
        >
          <a href="/resetpassword" className="flex-shrink mx-4 text-[#F96C41] font-semibold text-[10px] -tracking-[0.41px] md:text-[16px] md:-tracking-[0.68px] xl:text-[20px] fhd:text-[23px] 2k:text-[30px] 4k:text-[46px] xl:-tracking-[1.17px]">
            Forgotten password?
          </a>
        </motion.div>
        ...
        {/* Social Buttons */}
         <motion.div
          ...
          <button className="cursor-pointer w-[42px] h-[42px] md:w-[70px] md:h-[70px] xl:w-[90px] xl:h-[90px] 2k:w-[115px] 2k:h-[115px] 4k:w-[175px] 4k:h-[175px] p-2 rounded-lg md:rounded-xl xl:rounded-2xl bg-[#D9D9D9] hover:bg-[#D9D9D9]">
            <svg className='w-[24px] h-[24px] md:w-[40px] md:h-[40px] xl:w-[60px] 2k:w-[90px] 2k:h-[90px] 4k:w-[150px] 4k:h-[150px] xl:h-[60px] mx-auto' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
