    ...
    <div className="w-full relative -mt-4">
      <div className="relative w-full h-[200px] sm:h-[300px] md:h-[380px] lg:h-[520px] xl:h-[558px]">
        <Image
          ...
          fill
          className="object-cover rounded-[20px] xl:rounded-[68px]"
          quality={100}
          priority
        />
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 z-10">
          ...
          <div className="w-full flex justify-end mb-4 xl:mb-6">
            <button className="bg-transparent border-2 border-[#F96C41] text-white hover:bg-gradient-to-b hover:from-[#AA3916] hover:to-[#F96C41] cursor-pointer transition-colors rounded-xl w-full max-w-[150px] xs:max-w-[180px] sm:max-w-[220px] md:max-w-[260px] xl:max-w-[342px] xl:h-[85px] h-[40px] sm:h-[52px] md:h-[56px] flex items-center justify-between px-3 sm:px-6 md:px-8">
