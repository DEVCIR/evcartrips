...
export default function CarDiv() {
  return (
    <div className="w-full relative rounded-[24px]  xl:rounded-[68px]  -mt-4">
      <div className="relative w-full h-[200px] sm:h-[300px] md:h-[330px] lg:h-[430px] xl:h-[550px] shadow-2xl rounded-[24px] xl:rounded-[68px]">
        <Image
          src="/images/icons/imagesssssssss.png"
          alt="Background content"
          fill
          className="object-cover rounded-[24px]  xl:rounded-[68px]"
          quality={100}
          priority
        />
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 z-10">
          <div className="mt-6 sm:mt-10 sm:ml-4 flex flex-col lg:flex-row lg:items-center justify-between w-full gap-4 sm:gap-6 lg:gap-8">
            <div className="flex-1 max-w-none lg:max-w-lg xl:max-w-xl">
              <div className="text-white space-y-1 sm:space-y-2 md:space-y-0">
                <h1 className="text-sm sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl xl:-tracking-[1.4px] font-bold leading-tight  z-10">
                  EV Drivers Deserve Better
                </h1>
                <h2 className="text-sm sm:text-xl md:text-3xl lg:text-3xl xl:text-5xl xl:-tracking-[1.4px] font-bold leading-tight z-10">
                  Join the Club. Get More.
                </h2>
                <h3 className="text-sm sm:text-xl md:text-3xl lg:text-3xl xl:text-5xl xl:-tracking-[1.4px] font-bold leading-tight z-10">
                  Pay Less.
                </h3>
              </div>
            </div>
            ...
            <div className="absolute right-3 top-2/5 -translate-y-1/2 xl:right-10">
              <div className="block relative">
                <div className="relative w-[80px] h-[80px] sm:w-[140px] sm:h-[140px] md:w-[150px] md:h-[150px] lg:w-[180px] lg:h-[180px] xl:w-[222px] xl:h-[222px]">
