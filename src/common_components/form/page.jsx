            ...
            {showDatePicker && (
              <div className="absolute z-20 mt-1 w-full 4k:top-[310px] 4k:left-[150px] 2k:top-[120px] 2k:left-[30px]">
                <DatePicker
                  ...
                  minDate={new Date()}
                  inline
                  className="[&.react-datepicker]:border [&.react-datepicker]:border-gray-200 [&.react-datepicker]:shadow-lg [&.react-datepicker]:rounded-lg"
                  ...
                  dayClassName={() => "w-8 h-8 flex items-center justify-center mx-auto rounded-full hover:bg-gray-100"}
                  weekDayClassName={() => "text-xs text-gray-500"}
                  calendarClassName="bg-white p-2 2k:!scale-120 4k:!scale-220"
                />
              </div>
            )}
          </div>
              ...
              {activeDropdown === 'to' && (
                <div className="absolute z-10 mt-1 w-full bg-white border border-gray-300 rounded-lg fhd:rounded-xl 2k:rounded-2xl 4k:rounded-3xl shadow-lg max-2k:max-h-60 2k:max-h-96 4k:max-h-[28rem] overflow-auto">
                  {loadingCities ? (
                    ...
                    <div className="px-4 py-2 2k:py-4 4k:py-6 fhd:text-lg 2k:text-2xl 4k:text-4xl  text-gray-500">No cities found</div>
                  )}
                </div>
              )}
            </div>
