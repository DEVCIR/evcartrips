    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          className="px-4 py-2 md:px-8 md:py-4 rounded-md md:rounded-lg cursor-pointer bg-gradient-to-b from-[#F96C41] to-[#AA3916] hover:bg-gradient-to-l hover:from-[#AA3916] hover:to-[#F96C41] text-white shadow-lg flex items-center font-bold text-[8px] -tracking-[0.41px] md:text-[11px] md:-tracking-[0.81px]"
          whileHover={{
            scale: 1.05,
