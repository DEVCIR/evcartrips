    ...
    >
      <div className="flex flex-row 2k:gap-x-4 4k:gap-x-8">
        ...
        <div className="pl-4 flex flex-col justify-between w-2/5 md:w-3/5 text-black">
          <div>
            <motion.h2
              className="font-semibold text-[22px] -tracking-[0.44px] md:text-[29px] md:-tracking-[0.87px] xl:text-[40px] fhd:text-[50px] 2k:text-[70px] 4k:text-[90px] xl:-tracking-[1.5px] xl:leading-[50px] mb-1 md:mb-2 fhd:mb-5 2k:mb-10 4k:mb-18"
